...
export default function Navbar() {
  ...
  const { selectedProducts = [] } = useContext(ProductsContext); // Asegúrate de proporcionar un valor por defecto [] para selectedProducts
  const cartItemCount = selectedProducts.length;

  return (
    <nav className="sticky top-0 bg-white p-5 w-full flex border-t border-gray-200 justify-center space-x-12 text-gray-400">
